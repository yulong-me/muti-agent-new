...
const evolutionFeedbackModal = readFileSync(resolve(root, 'components/room-view/EvolutionFeedbackModal.tsx'), 'utf8')
const evolutionStream = readFileSync(resolve(root, 'components/room-view/evolutionStream.ts'), 'utf8')
const evolutionHook = readFileSync(resolve(root, 'components/room-view/useEvolutionProposals.ts'), 'utf8')
...
assert.match(evolutionStream, /type: 'delta'/)
assert.match(evolutionFeedbackModal, /Team Architect/)
